...
/******/ 	return __webpack_require__(__webpack_require__.s = "./components/check-box-group/CheckBoxGroup.tsx");
/******/ })
/************************************************************************/
/******/ ({

/***/ "./components/check-box-group/CheckBoxGroup.tsx":
/*!******************************************************!*\
  !*** ./components/check-box-group/CheckBoxGroup.tsx ***!
  \******************************************************/
...
/* harmony import */ var _style_index_scss__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./style/index.scss */ "./components/check-box-group/style/index.scss");
  ...
  _createClass(CheckBoxGroup, [{
    ...
    value: function render() {
      ...
      var _a = this.props,
          ...
          resetProps = __rest(_a, ["prefixCls", "className", "children", "disabled", "readOnly"]);

      var children = this.handleCloneChildren(cld);
      return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__["createElement"]("div", _extends({
        className: classnames__WEBPACK_IMPORTED_MODULE_1___default()(prefixCls, className, (_cls = {}, _defineProperty(_cls, "".concat(prefixCls, "-disabled"), disabled), _defineProperty(_cls, "".concat(prefixCls, "-readOnly"), readOnly), _cls))
      }, resetProps), children);
    }
  }, {
    key: "handleClick",
    value: function handleClick(radio) {
      var value = radio.props.value;
      var result = this.state.value; // 不存在

      if (this.state.value.find(function (v) {
        return v === value;
      }) !== undefined) {
    ...
    value: function handleCloneChildren(children) {
      ...
      return Array.isArray(children) ? children.map(function (radio) {
        return _this2.handleCloneChildren(radio);
      }) : react__WEBPACK_IMPORTED_MODULE_0__["cloneElement"](children, {
        key: children.key || "__".concat(+new Date() + Math.random(), "__"),
        checked: this.state.value.find(function (v) {
          return v === children.props.value;
        }) !== undefined,
        disabled: disabled || children.props.disabled,
        readOnly: readOnly || children.props.readOnly,
        onClick: function onClick() {
          return children.props.disabled || children.props.readOnly || _this2.handleClick(children);
        }
      });
    }
  }, {
