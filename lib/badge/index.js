...
/******/ 	return __webpack_require__(__webpack_require__.s = "./components/badge/Badge.tsx");
/******/ })
/************************************************************************/
/******/ ({
...
/* harmony import */ var _style_index_scss__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./style/index.scss */ "./components/badge/style/index.scss");
...
var BadgeProps = function BadgeProps() {
  _classCallCheck(this, BadgeProps);
...
var Badge = /*#__PURE__*/function (_React$PureComponent) {
  ...
  _createClass(Badge, [{
    ...
    value: function render() {
      ...
      }, this.props.children, this.props.hideIfCountIsZero && this.props.count <= 0 ? null : this.props.count > 0 && this.props.dot ? /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0__["createElement"]("sup", {
      ...
      }, this.props.maxCount > 0 ? this.props.count > this.props.maxCount ? "".concat(this.props.maxCount, "+") : this.props.count : this.props.count));
    }
  }]);
...
Badge.defaultProps = new BadgeProps();

/***/ }),

/***/ "./components/badge/style/index.scss":
/*!*******************************************!*\
  !*** ./components/badge/style/index.scss ***!
  \*******************************************/
