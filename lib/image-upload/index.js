(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		module.exports = factory(require("classnames"), require("react"), require("../icon"));
	else if(typeof define === 'function' && define.amd)
		define(["classnames", "react", "../icon"], factory);
	else {
		var a = typeof exports === 'object' ? factory(require("classnames"), require("react"), require("../icon")) : factory(root["classnames"], root["React"], root["../icon"]);
		for(var i in a) (typeof exports === 'object' ? exports : root)[i] = a[i];
	}
})(window, function(__WEBPACK_EXTERNAL_MODULE_classnames__, __WEBPACK_EXTERNAL_MODULE_react__, __WEBPACK_EXTERNAL_MODULE_wd_mobile_components_icon__) {
...
/******/ 	return __webpack_require__(__webpack_require__.s = "./components/image-upload/ImageUpload.tsx");
/******/ })
/************************************************************************/
/******/ ({
...
/***/ "./components/image-upload/ImageUpload.tsx":
/*!*************************************************!*\
  !*** ./components/image-upload/ImageUpload.tsx ***!
  \*************************************************/
/*! exports provided: ImageUploadProps, default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ImageUploadProps", function() { return ImageUploadProps; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return ImageUpload; });
/* harmony import */ var wd_mobile_components_icon_style___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! wd-mobile/components/icon/style/ */ "./components/icon/style/index.scss");
/* harmony import */ var wd_mobile_components_icon_style___WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(wd_mobile_components_icon_style___WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var wd_mobile_components_icon__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! wd-mobile/components/icon */ "wd-mobile/components/icon");
/* harmony import */ var wd_mobile_components_icon__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(wd_mobile_components_icon__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! react */ "react");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var classnames__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! classnames */ "classnames");
/* harmony import */ var classnames__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(classnames__WEBPACK_IMPORTED_MODULE_3__);
/* harmony import */ var _style_index_scss__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./style/index.scss */ "./components/image-upload/style/index.scss");
...
/* harmony import */ var lrz__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! lrz */ "./node_modules/_lrz@4.9.40@lrz/dist/lrz.all.bundle.js");
/* harmony import */ var lrz__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(lrz__WEBPACK_IMPORTED_MODULE_5__);
...
// 图片上传组件属性
var ImageUploadProps = function ImageUploadProps() {
  _classCallCheck(this, ImageUploadProps);
...
var ImageUpload = /*#__PURE__*/function (_React$PureComponent) {
  _inherits(ImageUpload, _React$PureComponent);
  ...
  function ImageUpload(props) {
    ...
    _this.compressSize = 200;
    /**
     * 图片数量
     */

    _this.imgAmount = _this.props.imgs.length;
    /**
     * 最大上传限制
     */

    _this.maxFileSize = 10 * 1048576;
    /**
     * 最大压缩限制，大于这个的都要压缩
     */

    _this.maxCompressSize = 0.5 * 1048576;
    /**
     * inputRef
     */

    _this.inputRef = react__WEBPACK_IMPORTED_MODULE_2__["createRef"]();
    /**
     * 选择文件
     */

    _this.fileChose = function (e) {
      var filesLength = e.target.files.length; // 计算本次上传图片数量

      var limitMax = _this.props.max <= 0 || _this.props.max >= filesLength ? filesLength : _this.props.max; // 遍历图片

      for (var i = 0; i < limitMax; i++) {
        var file = e.target.files[i]; // 检查图片是否超过最大限制

        if (file.size > _this.maxFileSize) {
          alert("".concat(file.name, "\uFF0C\u6587\u4EF6\u8FC7\u5927\uFF0C\u8BF7\u4E0A\u4F20\u5C0F\u4E8E").concat(_this.maxFileSize, "M\u7684\u56FE\u7247"));
          return false;
        } // 修复图片显示兼容


        _this.fixCompatible(file);
      }
    };
    /**
     * 修复图片显示兼容
    ...
    _this.fixCompatible = function (file) {
      lrz__WEBPACK_IMPORTED_MODULE_5___default()(file).then(function (rst) {
        _this.inputRef.current.value = null; // 检查图片是否大于最小压缩限制

        if (file.size > _this.maxCompressSize) {
          _this.compressImg(rst.base64);
        } else {
          _this.uploadImages(rst.base64);
        }
      })["catch"](function (err) {
  ...
  _createClass(ImageUpload, [{
    ...
    value: function render() {
      ...
      }, this.state.imgElemenList.map(function (item, index) {
        return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_2__["createElement"]("div", {
          key: index,
          className: "".concat(prefixCls, "-item ").concat(prefixCls, "-").concat(item.type, " ").concat(prefixCls, "-flex-rownum-").concat(_this2.props.rowNum),
          style: {
            backgroundImage: "url(".concat(item.showUrl, ")")
          }
        }, item.type == "img" && /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_2__["createElement"](wd_mobile_components_icon__WEBPACK_IMPORTED_MODULE_1___default.a, {
          className: "x-icon-close-circle",
          onClick: function onClick() {
            var imgItems = _toConsumableArray(_this2.imgItemList); // 获取已存在图片数组


            imgItems.splice(index, 1); // 删除指定索引图片

            _this2.imgAmount--; // 图片数量-1

            _this2.setImgList(imgItems);

            var imgListUrl = imgItems.map(function (item) {
              return item.realUrl || item.showUrl;
            }); // 删除图片回调

            _this2.props.onImgChange && _this2.props.onImgChange(imgListUrl);
          }
        }), item.type == "add" && /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_2__["createElement"]("input", {
          ref: _this2.inputRef,
          type: "file",
          accept: "image/*",
          multiple: true,
          className: "".concat(prefixCls, "-input"),
          onChange: _this2.fileChose
        }));
      }));
    } // 初始化图片列表数据
    ...
    key: "initImgListData",
    value: function initImgListData(imgs) {
      var imgItemList = [];

      if (!!imgs && Array.isArray(imgs)) {
        imgItemList = imgs.map(function (imgUrl) {
          return {
            showUrl: imgUrl,
            type: "img"
          };
    ...
    key: "compressImg",
    value: function compressImg(url) {
      var _this3 = this;
      ...
      img.onload = function () {
        // canvas压缩处理
        var xm = ~~(img.width / _this3.compressSize);
        var imgW = img.width / xm;
        var imgH = img.height / xm;
        ...
        base64Str = clipCanvas.toDataURL("image/png"); // 转成流上传

        _this3.uploadImages(base64Str);
      };
    }
    /**
     * 上传图片
    ...
    key: "uploadImages",
    value: function uploadImages(base64) {
      var _this4 = this;

      var inputName = "file";
      var apiUrl = this.props.uploadUrl; // 接口地址
      // 设置图片数据列表

      var imgItems = _toConsumableArray(this.imgItemList); // 获取已存在图片数组
      ...
      this.setImgList(imgItems); // 当前图片索引

      var thisItemIndex = imgItems.length - 1; // 请求
      ...
      var setFormData = function setFormData(blob) {
        var formData = new FormData();
        formData.append(inputName, blob, "".concat(new Date().getTime(), ".").concat(blob.type.split('/')[1]));
        return formData;
      }; // base64转blob
      ...
      ajax(apiUrl, setFormData(dataURLtoBlob(base64)), function (response) {
        var imgItems = _toConsumableArray(_this4.imgItemList); // 获取已存在图片数组


        imgItems[thisItemIndex].realUrl = JSON.parse(response).data[0]; // 设置上传后的地址

        _this4.setImgList(imgItems);

        var imgListUrl = imgItems.map(function (item) {
          return item.realUrl || item.showUrl;
        }); // 完成上传回调

        _this4.props.onImgChange && _this4.props.onImgChange(imgListUrl);
      });
    }
    /**
     * 设置图片数据
    ...
    key: "setImgList",
    value: function setImgList(imgItemList) {
      // 需要设置到state内的图片类元素数量
      var imgState = []; // 是否需要添加按钮

      var needAdd = this.props.max == 0 || this.props.max > imgItemList.length; // 最后一行元素数量

      var remainder = (imgItemList.length + (needAdd ? 1 : 0)) % this.props.rowNum; // 空元素数量，空元素是为了在flex下更好的实现排版的占位元素，实现即可换行又可均分

      var emptyNum = remainder == 0 ? 0 : this.props.rowNum - remainder; // 元素总量

      var totalNum = imgItemList.length + emptyNum + (needAdd ? 1 : 0); // 循环生成所有元素数组
...
ImageUpload.defaultProps = new ImageUploadProps();
...
/***/ "./node_modules/_lrz@4.9.40@lrz/dist/lrz.all.bundle.js":
/*!*************************************************************!*\
  !*** ./node_modules/_lrz@4.9.40@lrz/dist/lrz.all.bundle.js ***!
  \*************************************************************/
/*! no static exports found */
